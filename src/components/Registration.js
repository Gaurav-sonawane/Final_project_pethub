...
const Registration = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      axio
        .post("http://localhost:8082/api/registration/signup", {
  ...
  function validateAadhaar() {
    ...
    if (regexp.test(regestration.adhar_no)) {
  ...
  function ValidateEmail() {
    ...
    if (reg.test(regestration.email)) {
      return true;
    } else {
      return false;
    }
  ...
  function phonenumber() {
    ...
    if (phoneno.test(regestration.phono_no)) {
      return true;
    } else {
      return false;
    }
  ...
  function CheckPassword() {
    ...
    if (passw.test(regestration.password)) {
      return true;
    } else {
      return false;
    }
  ...
  function username() {
    ...
    if (usernameRegex.test(regestration.username)) {
      return true;
    } else {
      return false;
    }
